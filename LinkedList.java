...
public class LinkedList<E extends Comparable<E>> {
	...
	public void removeAll(E el) {
		...
		Node prev = null;
		removeAll(el, first, prev);
	}

	public void removeAll(E el, Node curr, Node prev) {
		if (curr == null) {
			return;
		} else {
	...
	public void duplicateAll(E el, Node curr) {
		if (curr == null) {
			return;
		} else {
			if (curr.data.equals(el)) {
